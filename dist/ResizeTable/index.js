...
var _default = function _default(props) {
  var handleResize = props.handleResize,
      ...
      scroll = props.scroll,
      table = props.table,
      rest = _objectWithoutProperties(props, ["handleResize", "columns", "scroll", "table"]);

  return /*#__PURE__*/_react.default.cloneElement(table, _objectSpread(_objectSpread({}, rest), {}, {
    components: {
      header: {
